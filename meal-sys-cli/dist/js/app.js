...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkedList = __webpack_require__(26);
	...
	var _shopList = __webpack_require__(38);

	var _shopList2 = _interopRequireDefault(_shopList);

	var _staple = __webpack_require__(40);

	var _staple2 = _interopRequireDefault(_staple);

	var _menuList = __webpack_require__(42);

	var _menuList2 = _interopRequireDefault(_menuList);

	var _stapleDetail = __webpack_require__(48);

	var _stapleDetail2 = _interopRequireDefault(_stapleDetail);
	...
	ws.onmessage = function (e) {
	    ...
	    switch (re.method) {
	        case 'loginSuccess':
	            ...
	            break;
	        case 'loginFail':
	            _appTips2.default.setTips(re.data);
	            break;
	        case 'logoutSuccess':
	            location.hash = '/login';
	            break;
	        ...
	        case 'getShopListSuccess':
	            _shop2.default.setData(re.data);
	            break;
	        case 'launchSuccess':
	            _book2.default.launchSuccess();
	            break;
	        case 'getBookListSuccess':
	            _book2.default.setData(re.data);
	            break;
	        case 'launchFail':
	            _appTips2.default.setTips(re.data);
	            break;
	        case 'getMenuListSuccess':
	            _menu2.default.setData(re.data);
	            break;
	        case 'getCheckedListSuccess':
	            _checkedList2.default.setData(re.data);
	            break;
	        case 'getStapleListSuccess':
	            _detail2.default.setData(re.data);
	            break;
	        case 'bookFinish':
	            _appTips2.default.setTips(re.data);
	            setTimeout(function () {
	...
	_react2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: 'shopList', component: _shopList2.default })
	    ),
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: 'staple', component: _staple2.default },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _menuList2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'menuList', component: _menuList2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'stapleDetail', component: _stapleDetail2.default })
	    )
	), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var AppTipsAction = _reflux2.default.createActions(['setTips']);

	module.exports = AppTipsAction;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var ShopAction = _reflux2.default.createActions(['getData', 'setData']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var BookAction = _reflux2.default.createActions(['getData', 'setData', 'launch', 'launchSuccess']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var MenuAction = _reflux2.default.createActions(['getData', 'setData']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var CheckedListAction = _reflux2.default.createActions(['getData', 'setData', 'check', 'cancel']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REFLUX actions
	var DetailAction = _reflux2.default.createActions(['getData', 'setData']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tips = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appTips = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _book3 = __webpack_require__(24);

	var _book4 = _interopRequireDefault(_book3);

	var _appLoading = __webpack_require__(35);
	...
	var BookList = _react2.default.createClass({
	    ...
	    mixins: [_reflux2.default.connect(_book2.default, 'shops')],
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        _book4.default.getData(function () {
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'em',
	                                    { className: 'cm-text-red' },
	                                    item.launcher
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'button',
	                                { className: 'btn', onClick: handleClick.bind(_this, item.id) },
	                                '我 要',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookStore = _reflux2.default.createStore({
	    init: function init() {
	        ...
	        this.listenTo(_book2.default.getData, this.getData);
	        this.listenTo(_book2.default.setData, this.setData);
	        this.listenTo(_book2.default.launch, this.launch);
	        this.listenTo(_book2.default.launchSuccess, this.launchSuccess);
	    },
	    ...
	    launchSuccess: function launchSuccess() {
	        this.cb && this.cb();
	        this.cb = null;
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appLoading = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shop = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Staple = _react2.default.createClass({
	    displayName: 'Staple',
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(_goBack2.default, { history: this.props.history }),
	                _react2.default.createElement(_logout2.default, null)
	            ),
	            _react2.default.createElement(
	                'footer',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('i', { className: 'iconfont icon-wucan1' }),
	                        ' 菜单列表'
	                    ),
	                    _react2.default.createElement(
	                        _reactRouter.Link,
	                        ...
	                        _react2.default.createElement('i', { className: 'iconfont icon-wucan' }),
	                        ' 点餐详情'
	                    )
	                )
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoBack = _react2.default.createClass({
	    displayName: 'GoBack',
	    handleClick: function handleClick() {
	        this.props.history.goBack();
	    },
	    render: function render() {
	        return _react2.default.createElement('a', { className: 'btn btn-l iconfont icon-back', onClick: this.handleClick.bind(this) });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkedList = __webpack_require__(47);

	var _checkedList2 = _interopRequireDefault(_checkedList);

	var _checkedList3 = __webpack_require__(26);

	var _checkedList4 = _interopRequireDefault(_checkedList3);
	...
	var MenuList = _react2.default.createClass({
	    displayName: 'MenuList',

	    mixins: [_reflux2.default.connect(_menu2.default, 'menus'), _reflux2.default.connect(_checkedList2.default, 'checkedList')],
	    ...
	    componentWillMount: function componentWillMount() {
	        var _this = this,
	            ...
	            _menu4.default.getData(_this.props.location.query.id, function () {
	                deferred.resolve();
	            });

	            return deferred.promise;
	        },
	            getCheckListData = function getCheckListData() {
	            var deferred = _q2.default.defer();

	            _checkedList4.default.getData(_this.props.location.query.id, function () {
	                deferred.resolve();
	            });
	        ...
	        _q2.default.allSettled([getMenuData(), getCheckListData()]).done(function (result) {
	            _appLoading2.default.hide();
	        });
	    },
	        ...
	        if (this.state.menus && this.state.menus.length == 0) {
	            ...
	            html = _react2.default.createElement(
	                ...
	                this.state.menus && this.state.menus.map(function (item, i) {
	                    var checked = false;
	                    if (_underscore2.default.indexOf(checkedList, item.id) != -1) {
	                        checked = true;
	                    }
	                    return _react2.default.createElement(
	                        'li',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { className: 'btn', style: {
	                                ...
	                                }, onClick: check.bind(_this, item.id) },
	                            '点餐'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn btn-cancel', style: {
	                                    display: checked ? '' : 'none'
	                                }, onClick: cancel.bind(_this, item.id) },
	                            '取消'
	                        )
	                    );
	                })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuStore = _reflux2.default.createStore({
	    init: function init() {
	        ...
	        this.listenTo(_menu2.default.getData, this.getData);
	        this.listenTo(_menu2.default.setData, this.setData);
	    },
	    ...
	    setData: function setData(menus) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckedListStore = _reflux2.default.createStore({
	    init: function init() {
	        this.data = {
	            checkedList: []
	        };

	        this.listenTo(_checkedList2.default.getData, this.getData);
	        this.listenTo(_checkedList2.default.setData, this.setData);
	        this.listenTo(_checkedList2.default.check, this.check);
	        this.listenTo(_checkedList2.default.cancel, this.cancel);
	    },
	    getData: function getData(shopId, callback) {
	        ws.send(JSON.stringify({
	    ...
	    setData: function setData(checkedList) {
	        this.data.checkedList = checkedList;
	        this.trigger(this.data.checkedList);
	        this.cb && this.cb();
	        this.cb = null;
	    },
	    check: function check(opts, callback) {
	        ws.send(JSON.stringify({
	            method: 'check',
	            data: {
	                shopId: opts.shopId,
	    ...
	    cancel: function cancel(opts, callback) {
	        ws.send(JSON.stringify({
	            method: 'cancel',
	            data: {
	                shopId: opts.shopId,
