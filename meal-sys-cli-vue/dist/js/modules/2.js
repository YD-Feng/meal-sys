...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.name = __vue_options__.name || "main"
	__vue_options__.__file = "e:\\czf-work\\myProject\\meal-sys\\meal-sys-cli-vue\\src\\views\\main.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (true) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-8c51f314", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-8c51f314", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  ...
	  return _h('i', {
	    staticClass: "iconfont icon-diancan1"
	  })
	}},function (){with(this) {
	  return _h('i', {
	    staticClass: "iconfont icon-diancan"
	  })
	}}]}
	if (true) {
	  module.hot.accept()
	  if (module.hot.data) {
	     __webpack_require__(16).rerender("data-v-8c51f314", module.exports)
	  }
	}
